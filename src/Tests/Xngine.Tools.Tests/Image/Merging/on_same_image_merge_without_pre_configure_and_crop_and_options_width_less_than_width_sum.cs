...
{
    public class on_same_image_merge_without_pre_configure_and_crop_and_options_width_less_than_width_sum : ImageMergeBase
    {
        ...
        [Assert]
        public void configurtion_result_image_width_should_have_128px()
           => result.Width.Should().Be(128);

        [Assert]
        public void configurtion_result_image_height_shoudl_have_32px()
           => result.Height.Should().Be(32);

        [Assert]
        public void configurtion_result_merged_image_shoud_have_128_x_32_dimension()
        {
            result.Image.Width.Should().Be(128);
